...
const Product = ({name, x, y}) => {
    ...
    return(<>
      <motion.div className="flex items-center justify-center text-center rounded-full font-semibold bg-black text-white p-2 shadow-black cursor-pointer text-sm"
  ...
  const Products = () => {
    return (
      <>    <div className="w-[100vw] px-3 py-16 flex flex-col items-center justify-center mt-10 bg-[#17C6D4]">
          ...
          <div className="w-[75%] h-96 relative rounded-full flex items-center justify-center" style={{background: `repeating-radial-gradient(rgba(151, 245, 108, 0.4) 2px, #fff 5px, #fff 100px 10%)`}} >
              <motion.div className="flex items-center justify-center rounded-full font-semibold bg-black text-white p-4 shadow-black cursor-pointer absolute text-center text-sm md:text=[10px]"
              whileHover={{scale: 1.05}}
