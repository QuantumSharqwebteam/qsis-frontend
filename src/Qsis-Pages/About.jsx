  ...
  return (
    <div className="px-5">
      <div className="lg:text-center">
        <h1 className="text-2xl font-light text-emerald-500 underline underline-offset-8">
          About Us
        </h1>
        <p className="mt-6 text-xl  m-auto lg:w-2/3 ">
        ...
        <p className=" mt-8 text-xl md:text-xl lg:w-2/3 m-auto">
        ...
        <div className="flex flex-col mt-14 justify-center items-center">
          <h1 className="text-2xl md:text-4xl font-light text-emerald-500 underline underline-offset-8">
            Find Us on Map
          </h1>

          <div className="grid grid-cols-1 md:grid-cols-2 mx-auto my-5 lg:w-1/2">
            <iframe
